! function(e) {
    ...
    i = function() {
        ...
        var o = this;
        return "boolean" == typeof e ? (i = e, e = i === !0 ? 0 : o.slideCount - 1) : e = i === !0 ? --e : e, !(o.slideCount < 1 || 0 > e || e > o.slideCount - 1) && (o.unload(), t === !0 ? o.$slideTrack.children().remove() : o.$slideTrack.children(this.options.slide).eq(e).remove(), o.$slides = o.$slideTrack.children(this.options.slide), o.$slideTrack.children(this.options.slide).detach(), o.$slideTrack.append(o.$slides), o.$slidesCache = o.$slides, void o.reinit())
    ...
    easeInElastic: function(e, i, t, o, s) {
        ...
        if (0 == i) return t;
        if (1 == (i /= s)) return t + o;
        if (r || (r = .3 * s), l < Math.abs(o)) {
            l = o;
            var n = r / 4
        } else var n = r / (2 * Math.PI) * Math.asin(o / l);
        return -(l * Math.pow(2, 10 * (i -= 1)) * Math.sin((i * s - n) * (2 * Math.PI) / r)) + t
    },
    easeOutElastic: function(e, i, t, o, s) {
        ...
        return l * Math.pow(2, -10 * i) * Math.sin((i * s - n) * (2 * Math.PI) / r) + o + t
    },
    easeInOutElastic: function(e, i, t, o, s) {
        ...
        if (r || (r = s * (.3 * 1.5)), l < Math.abs(o)) {
            l = o;
            var n = r / 4
        } else var n = r / (2 * Math.PI) * Math.asin(o / l);
        return i < 1 ? -.5 * (l * Math.pow(2, 10 * (i -= 1)) * Math.sin((i * s - n) * (2 * Math.PI) / r)) + t : l * Math.pow(2, -10 * (i -= 1)) * Math.sin((i * s - n) * (2 * Math.PI) / r) * .5 + o + t
    },
    ...
    easeInOutBounce: function(e, i, t, o, s) {
        return i < s / 2 ? .5 * jQuery.easing.easeInBounce(e, 2 * i, 0, o, s) + t : .5 * jQuery.easing.easeOutBounce(e, 2 * i - s, 0, o, s) + .5 * o + t
    }
});
var $ = jQuery;
! function() {
...
}(), App.modules.sliderHome = function() {
...
}(), App.modules.sliderHome.init(), App.modules.siteToScroll = function() {
    var e = function() {
            function e(e) {
                var i = $(document).scrollTop();
                $(".pagination-home-list a").each(function() {
                    var e = $(this),
                        t = $(e.attr("href"));
                    t.position().top - 90 <= i && t.position().top - 90 + t.height() > i ? ($(".pagination-home-list a").removeClass("active"), e.addClass("active")) : e.removeClass("active")
                })
            }
...
}(), App.modules.siteToScroll.init(), App.modules.popup = function() {
    var e = $(".cd-popup-trigger"),
        i = function() {
            $(".cd-popup-trigger").on("click", function(e) {
                e.preventDefault(), $(this).next($(".cd-popup")).addClass("is-visible"), $(".add_inspiration").css("z-index", "999")
            }), $(".cd-popup").on("click", function(e) {
                ($(e.target).is(".cd-popup-close") || $(e.target).is(".cd-popup")) && (e.preventDefault(), $(this).removeClass("is-visible"), $(".add_inspiration").css("z-index", "99"))
            }), $(document).keyup(function(e) {
                "27" == e.which && ($(".cd-popup").removeClass("is-visible"), $(".add_inspiration").css("z-index", "99"))
            })
        },
        t = function() {
            e.length && i()
...
}(), App.modules.popup.init(), App.modules.selectPopup = function() {
    var e = $(".inputfile"),
        i = function() {
            ! function(e, i, t) {
                var o = e.querySelectorAll(".inputfile");
                Array.prototype.forEach.call(o, function(e) {
                    var i = e.nextElementSibling,
                        t = i.innerHTML;
                    e.addEventListener("change", function(e) {
                        var o = "";
                        o = this.files && this.files.length > 1 ? (this.getAttribute("data-multiple-caption") || "").replace("{count}", this.files.length) : e.target.value.split("\\").pop(), o ? i.querySelector("span").innerHTML = o : i.innerHTML = t
...
}(), App.modules.selectPopup.init(), App.modules.video = function() {
    var e = $("#deniMovie"),
        i = function() {
            $("#btn-play").click(function(i) {
                $(".deniMovie-bg").fadeOut("slow"), e[0].play()
            }), $("#btn-pause").click(function(i) {
                $(".deniMovie-bg").fadeIn("slow"), e[0].pause()
            })
        },
        t = function() {
            e.length && i()
...
}(), App.modules.video.init(), App.modules.fotoLoader = function() {
    var e = $(".category_row"),
        i = $(".category_row-next"),
        t = $(".info-container__link"),
        o = $(".js-btn-cat-more"),
        s = $(".js-btn-cat-more span"),
        n = function() {
            o.click(function(e) {
                s.hasClass("no_click") ? (s.html("Collapse"), s.removeClass("no_click"), s.addClass("is_click"), i.fadeIn("slow", function() {})) : (s.html("SHOW MORE"), s.removeClass("is_click"), s.addClass("no_click"), i.fadeOut("slow", function() {})), $(".section-history__wrapper").css("position", "relative"), e.preventDefault()
            }), t.click(function(e) {
                s.hasClass("no_click") ? (s.html("Collapse"), s.removeClass("no_click"), s.addClass("is_click"), i.fadeIn("slow", function() {})) : (s.html("SHOW MORE"), s.removeClass("is_click"), s.addClass("no_click"), i.fadeOut("slow", function() {})), $(".section-history__wrapper").css("position", "relative"), e.preventDefault()
            })
        },
...
}(), App.modules.fotoLoader.init(), $(document).ready(function() {
